 ...
 */
package br.com.keyrus.poc.core.suggestion;
...
import br.com.keyrus.poc.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/keyruspoccore/test/testSimpleSuggestionService.csv", "utf-8");
	}
