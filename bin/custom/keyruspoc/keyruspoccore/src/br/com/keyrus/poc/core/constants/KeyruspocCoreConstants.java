 ...
 */
package br.com.keyrus.poc.core.constants;

/**
 * Global class for all KeyruspocCore constants. You can add global constants for your extension into this class.
 */
public final class KeyruspocCoreConstants extends GeneratedKeyruspocCoreConstants
{
	public static final String EXTENSIONNAME = "keyruspoccore";


	private KeyruspocCoreConstants()
	{
		//empty
	}
