...
//import java.util.stream.Collectors;
//
//public class CustomerPerformCronjob  extends AbstractJobPerformable<OutboundSyncCronJobModel> {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerPerformCronjob.class);
//
//    @Override
