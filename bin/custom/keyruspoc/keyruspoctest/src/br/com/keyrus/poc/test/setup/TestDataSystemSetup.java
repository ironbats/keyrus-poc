 ...
 */
package br.com.keyrus.poc.test.setup;
...
import br.com.keyrus.poc.test.constants.KeyruspocTestConstants;
import br.com.keyrus.poc.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KeyruspocTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/keyruspoctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/keyruspoctest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/keyruspoctest/import/cstickets.impex");
			...
			importImpexFile(context, "/keyruspoctest/import/csquotes.impex");
		}
	}
}
