 ...
 */
package br.com.keyrus.poc.fulfilmentprocess.test.jobs;
...
import br.com.keyrus.poc.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = KeyruspocFulfilmentProcessConstants.ORDER_PROCESS_NAME;
