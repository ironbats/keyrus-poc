 ...
 */
package br.com.keyrus.poc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(KeyruspocFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KeyruspocFulfilmentProcessConstants.PARENT_PROCESS);
