...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruspocstorefront/electronics/en",
						"https://electronics.local:9002/keyruspocstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruspocstorefront/electronics/en",
						"https://electronics.local:9002/keyruspocstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/keyruspocstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/keyruspocstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/keyruspocstorefront/electronics/en",
						"https://electronics.local:9002/keyruspocstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/keyruspocstorefront",
						"https://electronics.local:9002/keyruspocstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/keyruspocstorefront",
						"https://electronics.local:9002/keyruspocstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/keyruspocstorefront/electronics/en",
						"https://electronics.local:9002/keyruspocstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
